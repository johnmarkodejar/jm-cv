...
export const projects: Project[] = [
  ...
  {
    title: "Sabong BMS — Cockfighting Betting Management System",
    description: "Real-time betting management platform for licensed sabong (cockfighting) operations, with strict role separation across Administrator, Encoder, and Teller — covering match lifecycle control, pari-mutuel bet pooling, teller cash accountability, daily settlements, and a public live-odds display for venue screens.",
    category: "Betting Platform",
    technologies: [".NET", "Next.js", "PostgreSQL", "SignalR", "Docker", "Clean Architecture"],
    impact: "Automates pari-mutuel odds, fee calculation, and teller cash reconciliation with a full audit trail on every match, bet, and cash movement",
    gallery: [
      { src: "/portfolio/cbs/dashboard.png", alt: "Administrator dashboard with betting volume and revenue charts", caption: "Admin dashboard" },
      { src: "/portfolio/cbs/matches.png", alt: "Match list for a selected date with status and winner columns", caption: "Matches" },
      { src: "/portfolio/cbs/match-detail.png", alt: "Match detail page with live Meron/Wala pools and bet ledger", caption: "Match detail" },
      { src: "/portfolio/cbs/bets.png", alt: "All bets across matches with teller, side, amount and status", caption: "All bets" },
      { src: "/portfolio/cbs/users.png", alt: "User management showing Administrator, Teller and Encoder accounts", caption: "User management" },
      { src: "/portfolio/cbs/tellers.png", alt: "Teller list with running cash-on-hand balances", caption: "Tellers" },
      { src: "/portfolio/cbs/cash-management.png", alt: "Cash management screen for adding and collecting teller cash", caption: "Cash management" },
      { src: "/portfolio/cbs/settlements.png", alt: "Daily settlement screen for processing revenue and fees", caption: "Settlements" },
      { src: "/portfolio/cbs/reports.png", alt: "Revenue and betting volume reports by date range", caption: "Reports" },
      { src: "/portfolio/cbs/audit-logs.png", alt: "Immutable audit log of logins and system actions", caption: "Audit logs" },
      { src: "/portfolio/cbs/settings.png", alt: "Fee configuration and system tools settings page", caption: "Settings" },
      { src: "/portfolio/cbs/teller-betting.png", alt: "Teller fast-betting screen with keyboard-first bet slip", caption: "Teller — fast betting" },
      { src: "/portfolio/cbs/teller-receipt.png", alt: "Official printed bet receipt with claim QR code", caption: "Teller — bet receipt" },
      { src: "/portfolio/cbs/teller-scan-qr.png", alt: "Teller QR scanner for claiming winning bets", caption: "Teller — scan QR" },
      { src: "/portfolio/cbs/teller-cash-on-hand.png", alt: "Teller view of their own cash-on-hand balance and transactions", caption: "Teller — cash on hand" },
      { src: "/portfolio/cbs/encoder-controller.png", alt: "Encoder match controller for opening, closing and declaring matches", caption: "Encoder — match controller" },
      { src: "/portfolio/cbs/fight-info-display.png", alt: "Public live odds and pool distribution display for venue screens", caption: "Live venue display" },
    ],
  },
];
